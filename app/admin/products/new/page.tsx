...
//     setUploadingImages(files.map((_, i) => i)); // optional: show placeholders
//     try {
...
//             Add a new product to your store with images
//           </p>
//         </div>
//       </div>
...
//             </p>
//           )}
//           <div className="flex items-start gap-2 p-4 bg-neutral-700  border-none rounded-lg">
//             <AlertCircle
//               size={16}
