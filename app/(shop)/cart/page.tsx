...
//                       className="relative w-32 h-32 shrink-0 bg-gray-100 rounded-lg overflow-hidden group"
//                     >
//                       <Image
//                         src={item.image}
        ...
        <MaxWidthWrapper className="">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <Link
                href="/products"
                className="inline-flex items-center gap-2 text-primary hover:text-primary/90 font-medium transition mt-4"
              >
                ← Continue Shopping
              </Link>
            </div>
